...
public class uhh extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mPlanetTitles = getResources().getStringArray(R.array.usual_quotes);
		...
		mDrawerList.setAdapter(new ArrayAdapter<String>(this,
				R.layout.quote_real,R.id.arrow, mPlanetTitles));
		...
		mDrawerToggle = new ActionBarDrawerToggle(this,                  /* host Activity */
				...
				R.string.action_add_quote,  /* "open drawer" description */
